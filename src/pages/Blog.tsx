    ...
    <div className="w-full py-28 px-6 max-w-7xl mx-auto font-sans">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Expert tips, strategies, and insights to help you achieve your target IELTS band score
        </p>
      </div>
      ...
      {featuredPost && (
        <div className="mt-10 lg:w-10/12 mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 items-center bg-white rounded-xl shadow-[0_0_20px_#0EA5E91A]">
          ...
          <div className="p-5 md:p-8">
            ...
            {/* Only one Link → now it will open correctly */}
            <Link
              to={`/blog/${featuredPost.id}`}
              className="w-fit text-blue-600 text-sm font-medium block mt-2 hover:bg-blue-200 hover:rounded-2xl p-1 px-3 -ml-3"
            >
          ...
          >
            ...
            <div className="p-5">
              ...
              <div className="flex justify-between items-center mt-5">
                ...
                {/* Only one Link inside card */}
                <Link
                  to={`/blog/${post.id}`}
                  className="w-auto text-blue-600 text-sm font-medium block hover:bg-blue-200 hover:rounded-2xl p-1 px-3"
                >
                  Read the full article
                </Link>
              </div>
